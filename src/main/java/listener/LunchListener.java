...
public class LunchListener extends ListenerAdapter {
	...
	public void onMessageReceived(MessageReceivedEvent event) {
		...
		if (msg.startsWith("!yy")) {
			...
			// if문이 끝나면 cmd에는 lunch 가 있고 param에는 20191001이 있다
			...
			case "help":
				String helpText = "i995의 명령은 다음과 같습니다\n";
				helpText += "!yy echo [하고 싶은 말] : 하고 싶은 말을 봇이 따라합니다\n";
				helpText += "!yy lunch [날짜 - 20191001] : 해당 날짜의 급식을 가져옵니다\n";

				sayMsg(event, helpText);
				break;

			case "lunch":
				// param이 올바른 값인지 검사하는 로직이 들어가야 돼
